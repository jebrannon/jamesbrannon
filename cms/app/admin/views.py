...
class ContentView(BaseModelView):
    ...
    # Remove export, column-visibility and search-builder filter — not needed
    # for a single-user personal CMS; global search bar is sufficient
    export_types: list = []
...
class BrandView(SingletonView):
    ...
    fields = [
        ...
        StringField("role_title", label="Role / Title / Essence", required=False,
                    placeholder="eg. Soothsayer & Prophet"),
        ...
        URLField("linkedin", label="Profile URL", required=False,
                 placeholder="eg. https://linkedin.com/in/chrispbacon"),
        StringField("linkedin_text", label="Display", required=False,
                    placeholder="eg. LinkedIn /chrispbacon",
                    maxlength=60,
                    help_text="Display text shown for the profile link on the website. * Required if URL is set."),
        URLField("instagram", label="Profile URL", required=False,
                 placeholder="eg. https://instagram.com/chrispbacon"),
        StringField("instagram_text", label="Display", required=False,
                    placeholder="eg. Instagram @chrispbacon",
                    maxlength=60,
                    help_text="Display text shown for the profile link on the website. * Required if URL is set."),
        EmailField("email", label="Address", required=False,
                   placeholder="eg. christopher.p.bacon@mail.com"),
        StringField("email_text", label="Display", required=False,
                    placeholder="eg. Email christopher.p.bacon@mail.com",
                    maxlength=60,
                    help_text="Display text shown for the profile link on the website. * Required if address is set."),
    ]
